...
<div class="w-full h-auto bg-white pt-20">
    <div class="w-full max-w-5xl mx-auto">
        <div class="w-full max-w-xl">
            ...
            @endif
            <form action="/new-korkondasi" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                @csrf
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <textarea cols="30" rows="10" class="shadow appearance-none border rounded text-end w-full focues:outline-none" name="kolokasi"></textarea>
                </div>
                <div class="mb-4">
                    <label class="block text-gray-700 text-sm font-bold mb-2" for="username">
                        Url video
                    </label>
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-start" id="username" type="text" name="url" required>
                </div>
